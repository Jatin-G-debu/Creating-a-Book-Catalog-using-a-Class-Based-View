...
from .views import BookRecordFormView, FormSuccessView , BookCreateView , BookUpdateView ,BookDeleteView,BookRecordDetail
urlpatterns = [
    ...
    path('book_record_detail/<int:pk>',BookRecordDetail.as_view(), name='book_detail'),
    ]
